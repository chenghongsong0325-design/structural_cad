...
# ---------------------------------------------------------------------------
# 規範(單位 cm,此處換算成 mm):
#   其餘 RC 牆厚 15cm、1/2B 磚牆厚 12cm、電梯間 RC 牆厚 20cm、陽台牆厚 10cm。
# 語意上:外牆用一般 RC 牆(15cm)、內牆用 1/2B 磚牆(12cm)當預設;
# 另提供電梯間、陽台的專用牆厚常數。
EXTERIOR_WALL_THICKNESS = 150   # 一般 RC 牆(其餘 RC 牆厚 15cm)
INTERIOR_WALL_THICKNESS = 120   # 1/2B 磚牆(12cm)
ELEVATOR_WALL_THICKNESS = 200   # 電梯間 RC 牆(20cm)
BALCONY_WALL_THICKNESS = 100    # 陽台牆(10cm)
...
# PENDING(待確認假設彙整)
# =============================================================================
# 1. 牆厚:已依競賽「構造尺寸」規範設定(RC 牆 15cm、1/2B 磚牆 12cm、電梯 20cm、
#    陽台 10cm)。哪一道牆用哪種厚度由呼叫端依實際位置選用。
